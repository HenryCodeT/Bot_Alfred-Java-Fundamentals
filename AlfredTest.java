public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("Alexis Toca algunos beats low-fi.".indexOf("Alexis"));
        System.out.println("No puedo encontrar mi yo-yo. Quizas Alfred sepa dónde está".indexOf("Alfred"));
    }
}